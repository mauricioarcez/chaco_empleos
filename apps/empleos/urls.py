...
from .views import AgregarEmpleo, lista_empleos, ListaMisEmpleos, ListaEmpleosPorCategoria, detalle_empleo, EditarEmpleo, EliminarEmpleo

app_name = 'apps.empleos'

urlpatterns = [
    path('agregar_empleo/', AgregarEmpleo.as_view(), name='agregar_empleo'),
    path('lista_empleos/', lista_empleos, name='empleos'),
